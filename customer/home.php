...
<body>
    ...
    ?>
    <div class="search-form d-flex justify-content-center mt-2">
    ...
    {
        $sql_result = mysqli_query($conn, "SELECT * FROM products WHERE category='$category'");
    ...
    ?>
                <div class='product-card'>
                    ...
                    <a href='addcart.php?pid=<?php echo $dbrow['id']; ?>'>
